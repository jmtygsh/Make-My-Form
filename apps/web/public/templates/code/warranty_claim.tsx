      ...
      <div className="grid grid-cols-12 gap-4">
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            <span className="text-lg font-semibold">Warranty Claim</span>
            <br />
            <span className="text-sm text-muted-foreground">
              Submit a warranty claim for defective products or services.
            </span>
          </p>
        </div>
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              <Input
                key="text-input-2"
                placeholder="Store or website where purchased"
                type="text"
                className=""
                {...field}
              />
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  <SelectItem key="defective" value="defective">
                    Defective Product
                  </SelectItem>

                  <SelectItem key="not-working" value="not-working">
                  ...
                  <SelectItem key="missing-parts" value="missing-parts">
                    Missing Parts
                  </SelectItem>

                  <SelectItem key="poor-service" value="poor-service">
