...
export default function VehicleDamageReport() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      "text-input-0": "",
      "text-input-1": "",
      "date-input-0": new Date("2025-11-07T13:00:39.932Z"),
      "text-input-2": "",
      "select-0": "",
      "textarea-0": "",
      "file-input-0": "",
      ...
      <div className="grid grid-cols-12 gap-4">
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            <span className="text-lg font-semibold">Vehicle Damage Report</span>
            <br />
            <span className="text-sm text-muted-foreground">
              Report any damage to your rental vehicle immediately.
            </span>
          </p>
        </div>
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  <SelectItem key="collision" value="collision">
                    Collision Damage
                  </SelectItem>

                  <SelectItem key="scratch" value="scratch">
                    Scratches
                  </SelectItem>

                  <SelectItem key="dent" value="dent">
                    Dents
                  </SelectItem>
                  ...
                  <SelectItem key="theft" value="theft">
                    Theft/Vandalism
                  </SelectItem>

                  <SelectItem key="mechanical" value="mechanical">
                    Mechanical Issue
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            >
              ...
              >
                ...
                <div className="grid gap-1.5 leading-none">
                  <FieldLabel>Police report filed</FieldLabel>
