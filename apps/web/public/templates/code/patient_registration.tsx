...
export default function PatientRegistration() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      "text-input-0": "",
      "text-input-1": "",
      "date-input-0": new Date("2025-11-07T13:00:40.271Z"),
      "email-input-0": "",
      "tel-input-0": "",
      "textarea-0": "",
      "text-input-2": "",
      ...
      <div className="grid grid-cols-12 gap-4">
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            <span className="text-lg font-semibold">Patient Registration</span>
            <br />
            <span className="text-sm text-muted-foreground">
              Complete your patient registration form for our healthcare
              facility.
            </span>
          </p>
        </div>
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  <SelectItem key="bluecross" value="bluecross">
                    Blue Cross Blue Shield
                  </SelectItem>

                  <SelectItem key="aetna" value="aetna">
                    Aetna
                  </SelectItem>

                  <SelectItem key="cigna" value="cigna">
                    Cigna
                  </SelectItem>

                  <SelectItem key="unitedhealth" value="unitedhealth">
                    UnitedHealth
                  </SelectItem>

                  <SelectItem key="medicare" value="medicare">
                    Medicare
                  </SelectItem>

                  <SelectItem key="medicaid" value="medicaid">
                    Medicaid
                  </SelectItem>
