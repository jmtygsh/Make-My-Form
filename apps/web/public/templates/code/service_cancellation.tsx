...
export default function ServiceCancellation() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      "email-input-0": "",
      "radio-group-0": "",
      "date-input-0": new Date("2025-11-07T13:00:40.562Z"),
      "textarea-0": "",
    },
  });
      ...
      <div className="grid grid-cols-12 gap-4">
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            <span className="text-lg font-semibold">Service Cancellation</span>
            <br />
            <span className="text-sm text-muted-foreground">
              Cancel your service subscription and provide feedback.
            </span>
          </p>
        </div>
            ...
            >
              ...
              >
                <FieldLabel
                  ...
                  htmlFor="radio-group-0-cost"
                >
                  <RadioGroupItem value="cost" id="radio-group-0-cost" />
                ...
                <FieldLabel
                  key="moving"
                  className="flex items-center has-[[data-state=checked]]:border-primary w-full rounded-md border p-4 space-x-2"
                  htmlFor="radio-group-0-moving"
                >
                  <RadioGroupItem value="moving" id="radio-group-0-moving" />
                  <div className="grid gap-2 leading-none">
                    <FieldLabel
                      htmlFor="radio-group-0-moving"
                      className="font-normal"
                ...
                <FieldLabel
                  key="competitor"
                  className="flex items-center has-[[data-state=checked]]:border-primary w-full rounded-md border p-4 space-x-2"
                  htmlFor="radio-group-0-competitor"
                >
                  <RadioGroupItem
                    value="competitor"
                    id="radio-group-0-competitor"
                  />
                  <div className="grid gap-2 leading-none">
                    <FieldLabel
                      htmlFor="radio-group-0-competitor"
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              <Textarea
                key="textarea-0"
                id="textarea-0"
                placeholder="Any feedback about our service"
                className=""
                {...field}
              />
