...
export default function HotelBooking() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      "tel-input-0": "",
      "text-input-1": "",
      "date-input-0": new Date("2025-11-07T13:00:40.668Z"),
      "date-input-1": new Date("2025-11-07T13:00:40.668Z"),
      "select-0": "",
      "select-1": "",
      "select-2": "",
      "checkbox-group-0": [],
      ...
      <div className="grid grid-cols-12 gap-4">
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            <span className="text-lg font-semibold">Hotel Booking</span>
            <br />
            <span className="text-sm text-muted-foreground">
              Reserve your hotel room for a comfortable stay.
            </span>
          </p>
        </div>
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem key="twin" value="twin">
                    Twin Room
                  </SelectItem>
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem key="deluxe" value="deluxe">
                    Deluxe
                  </SelectItem>
                  ...
                  <SelectItem key="presidential" value="presidential">
                    Presidential
                  </SelectItem>
                </SelectContent>
              </Select>
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-early-checkin"
                          checked={OptionField.value?.includes("early-checkin")}
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            ...
                            htmlFor="checkbox-group-0-early-checkin"
                          >
                            Early Check-in
                          </FieldLabel>
                        </div>
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-late-checkout"
                          checked={OptionField.value?.includes("late-checkout")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-late-checkout"
                          >
                            Late Check-out
                          </FieldLabel>
                        </div>
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-non-smoking"
                          checked={OptionField.value?.includes("non-smoking")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                              ...
                              : OptionField.onChange(
                                OptionField.value?.filter(
                                  (value: string) => value !== "non-smoking",
                                ),
                              );
                          }}
                        />
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-non-smoking"
                          >
                            Non-smoking Room
                          </FieldLabel>
                        </div>
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-accessible"
                          checked={OptionField.value?.includes("accessible")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-accessible"
                          >
                            Accessible Room
                          </FieldLabel>
                        </div>
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-connecting"
                          checked={OptionField.value?.includes("connecting")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-connecting"
                          >
                            Connecting Rooms
                          </FieldLabel>
                        </div>
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-high-floor"
                          checked={OptionField.value?.includes("high-floor")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-high-floor"
                          >
                            High Floor
                          </FieldLabel>
                        </div>
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-quiet"
                          checked={OptionField.value?.includes("quiet")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-quiet"
                          >
                            Quiet Room
                          </FieldLabel>
                        </div>
