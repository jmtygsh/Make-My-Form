...
export default function SoftwareLicenseRequest() {
        ...
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            ...
            <span className="text-sm text-muted-foreground">
              Request licenses for software tools and applications.
            </span>
          </p>
        </div>
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              <Input
                key="text-input-0"
                placeholder="Requesting employee name"
                type="text"
                className=""
                {...field}
              />
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-office"
                          checked={OptionField.value?.includes("office")}
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            ...
                            htmlFor="checkbox-group-0-office"
                          >
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-adobe"
                          checked={OptionField.value?.includes("adobe")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-adobe"
                          >
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-autocad"
                          checked={OptionField.value?.includes("autocad")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-autocad"
                          >
                            AutoCAD
                          </FieldLabel>
                        </div>
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-jira"
                          checked={OptionField.value?.includes("jira")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-slack"
                          checked={OptionField.value?.includes("slack")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                        ...
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-slack"
                          >
                            Slack Premium
                          </FieldLabel>
                        </div>
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem key="perpetual" value="perpetual">
                    Perpetual
                  </SelectItem>
