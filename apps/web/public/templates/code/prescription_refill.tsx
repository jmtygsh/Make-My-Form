...
export default function PrescriptionRefillRequest() {
        ...
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            ...
            <span className="text-sm text-muted-foreground">
              Request a refill for your prescription medications.
            </span>
          </p>
        </div>
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  <SelectItem key="cvs" value="cvs">
                    CVS Pharmacy
                  </SelectItem>

                  <SelectItem key="walgreens" value="walgreens">
                    Walgreens
                  </SelectItem>

                  <SelectItem key="rite-aid" value="rite-aid">
                    Rite Aid
                  </SelectItem>

                  <SelectItem key="walmart" value="walmart">
                    Walmart Pharmacy
                  </SelectItem>

                  <SelectItem key="kroger" value="kroger">
                    Kroger Pharmacy
                  </SelectItem>
