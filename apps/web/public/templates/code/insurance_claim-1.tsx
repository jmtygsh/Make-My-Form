...
export default function InsuranceClaimForm() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      "text-input-0": "",
      "text-input-1": "",
      "date-input-0": new Date("2025-11-07T13:00:40.309Z"),
      "text-input-2": "",
      "text-input-3": "",
      "select-0": "",
      "textarea-0": "",
      ...
      <div className="grid grid-cols-12 gap-4">
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            <span className="text-lg font-semibold">Insurance Claim Form</span>
            <br />
            <span className="text-sm text-muted-foreground">
              Submit a medical insurance claim for reimbursement.
            </span>
          </p>
        </div>
