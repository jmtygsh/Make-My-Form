...
export default function AdditionalDriverVerification() {
        ...
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            ...
            <span className="text-sm text-muted-foreground">
              Add an authorized driver to your rental agreement.
            </span>
          </p>
        </div>
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              <Input
                key="text-input-0"
                placeholder="Primary renter name"
                type="text"
                className=""
                {...field}
              />
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              <Input
                key="text-input-2"
                placeholder="Additional driver full name"
                type="text"
                className=""
                {...field}
              />
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  <SelectItem key="us-ca" value="us-ca">
                    California
                  </SelectItem>

                  <SelectItem key="us-ny" value="us-ny">
                    New York
                  </SelectItem>

                  <SelectItem key="us-tx" value="us-tx">
                    Texas
                  </SelectItem>

                  <SelectItem key="us-fl" value="us-fl">
                    Florida
                  </SelectItem>
