...
export default function RentalApplication() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      "text-input-0": "",
      "text-input-1": "",
      "date-input-0": new Date("2025-11-07T13:00:40.536Z"),
      "email-input-0": "",
      "tel-input-0": "",
      "textarea-0": "",
      "text-input-2": "",
      ...
      "text-input-6": "",
      "select-0": "",
      "date-input-1": new Date("2025-11-07T13:00:40.536Z"),
      "textarea-1": "",
      "checkbox-0": false,
    },
  });
      ...
      <div className="grid grid-cols-12 gap-4">
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            <span className="text-lg font-semibold">Rental Application</span>
            <br />
            <span className="text-sm text-muted-foreground">
              Apply for a rental property with your personal and financial
              information.
            </span>
          </p>
        </div>
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              <Input
                key="text-input-6"
                placeholder="Property you&#039;re applying for"
                type="text"
                className=""
                {...field}
              />
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem key="18-months" value="18-months">
                    18 Months
                  </SelectItem>

                  <SelectItem key="24-months" value="24-months">
                    24 Months
                  </SelectItem>

                  <SelectItem key="month-to-month" value="month-to-month">
                    Month to Month
                  </SelectItem>
                </SelectContent>
              </Select>
