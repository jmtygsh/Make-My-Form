...
const FormEditPage = () => {
  ...
  const actions = [
    { name: "Add logo", icon: Hexagon, onClick: () => updateTheme({ showLogo: !showLogo }) },
    {
      name: "Add cover",
      icon: LayoutTemplate,
      onClick: () => updateTheme({ showCover: !showCover }),
    },
      ...
      >
        <div className="sticky top-0 flex items-center px-4 py-3">
          <button
            ...
            className="flex items-center gap-1.5 rounded-md border border-current/20 bg-current/5 px-3 py-1 text-sm font-medium shadow-sm transition-colors hover:opacity-80"
          >
            ← Back to editor
          </button>
        </div>
        <FormRenderer shortId={formId} title={formTitle} payload={payload} mode="preview" />
      </div>
    );
  }
    ...
    <div className="relative flex min-h-screen flex-col bg-white font-sans text-gray-900">
      <header className="flex items-center justify-between border-b border-transparent px-4 py-3">
        <div className="flex items-center gap-2 text-sm font-medium text-gray-500">
          ...
          <span className="cursor-pointer rounded px-1.5 py-0.5 transition-colors hover:bg-gray-100">
            My workspace
          </span>
          <span className="text-gray-300">/</span>
      ...
      >
        ...
        <div
          ...
          style={{ maxWidth: pageWidth, color: textColor, fontSize: baseFontSize }}
        >
          <div
            className={`${showLogo && showCover ? "absolute left-10 top-0 -translate-y-1/2" : ""} flex items-center gap-2`}
          >
            {showLogo && (
              <div
          ...
          {isBuilderActive ? (
            ...
            <>
              ...
              <div className="mb-12 text-[15px] leading-relaxed opacity-80">
                <p>
                  A form builder that{" "}
                  <span className="rounded bg-primary/60 px-1.5 py-0.5 font-medium text-black">
                    works like a doc
                  </span>
                  .
                </p>
                <p>
                  Just type{" "}
                  <span className="rounded bg-gray-100 px-1.5 py-0.5 text-sm font-medium text-gray-800">
                    /
                  </span>{" "}
                  to insert a block.
                </p>
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <FooterLink
                      ...
                      text="Get started with templates"
                    />
