        ...
        <div key="text-0" id="text-0" className=" col-span-12 col-start-auto">
          <p className="leading-7 not-first:mt-6">
            ...
            <span className="text-sm text-muted-foreground">
              Book your spot at our upcoming event.
            </span>
          </p>
        </div>
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem key="early-bird" value="early-bird">
                    Early Bird
                  </SelectItem>
                </SelectContent>
              </Select>
                ...
                <Controller
                  ...
                  render={({ field: OptionField }) => {
                    return (
                      ...
                      >
                        <Checkbox
                          id="checkbox-group-0-interpreter"
                          checked={OptionField.value?.includes("interpreter")}
                          onCheckedChange={(checked) => {
                            return checked
                              ? OptionField.onChange([
                                ...(OptionField.value || []),
                              ...
                              : OptionField.onChange(
                                OptionField.value?.filter(
                                  (value: string) => value !== "interpreter",
                                ),
                              );
                          }}
                        />
                        <div className="grid gap-2 leading-none">
                          <FieldLabel
                            className="font-normal"
                            htmlFor="checkbox-group-0-interpreter"
                          >
