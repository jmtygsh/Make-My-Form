...
export default function APIDocumentationFeedback() {
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  <SelectItem key="getting-started" value="getting-started">
                    Getting Started
                  </SelectItem>
                  ...
                  <SelectItem key="endpoints" value="endpoints">
                    API Endpoints
                  </SelectItem>

                  <SelectItem key="examples" value="examples">
                    Code Examples
                  </SelectItem>

                  <SelectItem key="troubleshooting" value="troubleshooting">
                    Troubleshooting
                  </SelectItem>
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              >
                ...
                <SelectContent>
                  <SelectItem key="unclear" value="unclear">
                    Unclear Explanation
                  </SelectItem>
                  ...
                  <SelectItem key="outdated" value="outdated">
        ...
        <Controller
          ...
          render={({ field, fieldState }) => (
            ...
            >
              ...
              <Input
                key="text-input-1"
                placeholder="Code snippet or example (if applicable)"
                type="text"
                className=""
                {...field}
              />
